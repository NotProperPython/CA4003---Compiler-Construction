...
public interface calVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code NempParam}
	 * labeled alternative in {@link calParser#nemp_parameter_list}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNempParam(calParser.NempParamContext ctx);
	/**
	 * Visit a parse tree produced by the {@code NempParamList}
	 * labeled alternative in {@link calParser#nemp_parameter_list}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNempParamList(calParser.NempParamListContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link calParser#fragment_}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFragment_(calParser.Fragment_Context ctx);
	/**
