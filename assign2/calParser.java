...
public class calParser extends Parser {
	...
	public static class NempParamContext extends Nemp_parameter_listContext {
		public TerminalNode ID() { return getToken(calParser.ID, 0); }
		public TerminalNode COLON() { return getToken(calParser.COLON, 0); }
		public TypeContext type() {
			return getRuleContext(TypeContext.class,0);
		}
		public NempParamContext(Nemp_parameter_listContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof calVisitor ) return ((calVisitor<? extends T>)visitor).visitNempParam(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class NempParamListContext extends Nemp_parameter_listContext {
		public TerminalNode ID() { return getToken(calParser.ID, 0); }
		public TerminalNode COLON() { return getToken(calParser.COLON, 0); }
		public TypeContext type() {
			return getRuleContext(TypeContext.class,0);
		...
		public NempParamListContext(Nemp_parameter_listContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof calVisitor ) return ((calVisitor<? extends T>)visitor).visitNempParamList(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final Nemp_parameter_listContext nemp_parameter_list() throws RecognitionException {
		...
		try {
			...
			case 1:
				_localctx = new NempParamContext(_localctx);
				enterOuterAlt(_localctx, 1);
				{
				setState(95);
				match(ID);
				...
				break;
			case 2:
				_localctx = new NempParamListContext(_localctx);
				enterOuterAlt(_localctx, 2);
				{
				setState(98);
				match(ID);
	...
	public static class Fragment_Context extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof calVisitor ) return ((calVisitor<? extends T>)visitor).visitFragment_(this);
			else return visitor.visitChildren(this);
		}
	}
